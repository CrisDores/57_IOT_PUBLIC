...
class esp_ble
{
    const char *PIC_SERVICE_UUID = "dd249079-0ce8-4d11-8aa9-53de4040aec6";
    const char *ESP_SERVICE_UUID = "33e3a05a-c397-4bed-81b0-30deb11495c7";
    ...
    const char *OTA_CH_UUID = "6e364bda-5f52-4d58-979d-44693840d271";
    ...
    NimBLEService *pic_service_p; // BLE VARS
    NimBLEService *esp_service_p;

public:
    NimBLECharacteristic *tools_p; // tools pointer
    NimBLECharacteristic *keys_p;
    NimBLECharacteristic *ota_p;
